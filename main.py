...
def que_5_get(message):
    ...
    bot.set_state(message.from_user.id, Question.result_5, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_5'] = message.text

# result
@bot.message_handler(state=Question.result_5)
...
def que_6_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_7, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_6'] = message.text

@bot.message_handler(state=Question.que_7)
def que_7_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_8, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_7'] = message.text

@bot.message_handler(state=Question.que_8)
def que_8_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_9, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_8'] = message.text

@bot.message_handler(state=Question.que_9)
def que_9_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_10, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_9'] = message.text

@bot.message_handler(state=Question.que_10)
def que_10_get(message):
    bot.send_message(message.chat.id, "Nice. Let`s look on you answer!")
    bot.send_message(message.chat.id, 'Write anything...')
    bot.set_state(message.from_user.id, Question.result_10, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_10'] = message.text

# result
@bot.message_handler(state=Question.result_10)
def ready_for_answer(message):
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        msg = ("Ready, take a look:\n<b>"
               f"1: {data['que_1']}\n"
...
def que_10_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_11, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_10'] = message.text

@bot.message_handler(state=Question.que_11)
def que_11_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_12, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_11'] = message.text

@bot.message_handler(state=Question.que_12)
def que_12_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_13, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_12'] = message.text

@bot.message_handler(state=Question.que_13)
def que_13_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_14, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_13'] = message.text

@bot.message_handler(state=Question.que_14)
def que_14_get(message):
    ...
    bot.set_state(message.from_user.id, Question.que_15, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_14'] = message.text


@bot.message_handler(state=Question.que_15)
def que_15_get(message):
    bot.send_message(message.chat.id, "Nice. Let`s look on you answer!")
    bot.send_message(message.chat.id, 'Write anything...')
    bot.set_state(message.from_user.id, Question.result_15, message.chat.id)
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        data['que_15'] = message.text

# result
@bot.message_handler(state=Question.result_15)
def ready_for_answer(message):
    with bot.retrieve_data(message.from_user.id, message.chat.id) as data:
        msg = ("Ready, take a look:\n<b>"
               f"1: {data['que_1']}\n"
